...
*/
// * Add your code BELOW here
const firstLetterIsA = 'Ampersand';
// * Don't mess with the test code below here!
test('firstLetterIsA', () => {
...
/* ==============================
   ...
   Challenge Question:
     ...
     - Strings are immutable, meaning you cannot alter the assigned value of the variables. You can reassign them (so long as they aren't constants)
     - but you cannot change the individual characters of the string. This may be because JavaScript has no definition for characters as a type.
*/
